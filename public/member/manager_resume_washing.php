...
<div class="row">
    <div class="col-md-12">
        <div class="page-header d-flex">
            <h3 class="mr-auto">Resume Leadtime Service Plus</h3>
        ...
        <div class="member-content pt-5">
            <form class="row" id="sorting_data" method="POST" action="<?=BASE_URL?>/member/mana/export-resume-washing">
                <div class="col-md-4">
        ...
        $(document).ready(function() {
            ...
            var mytable = $('#table').DataTable({
                ...
                "ajax": {
                    "dataType": "JSON",
                    'type': 'post',
                    'url': BASE_URL + '/member/manager/datatable',
                    data: function (data) {
                        data.startOfMonth   = awal;
                        data.endOfMonth = akhir;
                    }
                }
            });
        });     
