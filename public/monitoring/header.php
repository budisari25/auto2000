...
<header id="s-bar">
    ...
    <!-- Product -->
    <div class="s-product">
    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#">DigitalECtrlJob <span class="badge">APPS</span></a>
    <div class="dropdown-menu">
        <a href="<?=BASE_URL?>/opl" class="dropdown-item">Progres OPL</a>
    </div>
    </div>
    <!-- /.app -->
